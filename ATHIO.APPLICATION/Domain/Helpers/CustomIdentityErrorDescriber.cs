...
namespace AUTHIO.APPLICATION.Domain.Helpers;

/// <summary>
/// IdentityErrorDescriber customizado para erros em pt-bt.
/// </summary>
public class CustomIdentityErrorDescriber : IdentityErrorDescriber
{
    ...
    public override IdentityError DuplicateEmail(string email) { 
        return new IdentityError { Code = nameof(DuplicateEmail), Description = $"E-mail '{email}' já está sendo utilizado." }; }

    ...
    public partial class INITIAL : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("99b6f456-b50e-4e56-a712-9de2d88606d1"), null, new DateTime(2024, 10, 18, 0, 10, 5, 245, DateTimeKind.Local).AddTicks(5706), "System", "SYSTEM", 1, true, null, null });

            migrationBuilder.InsertData(
                table: "Plans",
                columns: new[] { "Id", "Created", "Description", "MonthlyPayment", "Name", "ProductId", "QuantTenants", "QuantUsers", "Status", "Updated", "Value" },
                values: new object[] { new Guid("78cb957b-dba2-401a-b123-66019da6bca5"), new DateTime(2024, 10, 18, 0, 10, 5, 245, DateTimeKind.Local).AddTicks(5902), "Plano para estudos.", true, "Básico", null, 0, 10, 1, null, 10m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Tenants", "POST", new Guid("99b6f456-b50e-4e56-a712-9de2d88606d1") },
                    { 2, "Tenants", "GET", new Guid("99b6f456-b50e-4e56-a712-9de2d88606d1") },
                    { 3, "Tenants", "PATCH", new Guid("99b6f456-b50e-4e56-a712-9de2d88606d1") },
                    { 4, "Tenants", "PUT", new Guid("99b6f456-b50e-4e56-a712-9de2d88606d1") }
                });

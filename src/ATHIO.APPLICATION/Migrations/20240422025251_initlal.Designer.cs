...
namespace AUTHIO.APPLICATION.Migrations
{
    ...
    [Migration("20240422025251_initlal")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AUTHIO.APPLICATION.Domain.Entities.LockoutIdentityConfigurationEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AUTHIO.APPLICATION.Domain.Entities.RoleEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1dd39ecf-70e0-4de6-8c18-0f6748df44bc"),
                            Created = new DateTime(2024, 4, 21, 23, 52, 51, 523, DateTimeKind.Local).AddTicks(4637),
                            Name = "System",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClaimType = "Tenants",
                            ClaimValue = "POST",
                            RoleId = new Guid("1dd39ecf-70e0-4de6-8c18-0f6748df44bc")
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("AUTHIO.APPLICATION.Domain.Entities.LockoutIdentityConfigurationEntity", b =>
                {
                    b.HasOne("AUTHIO.APPLICATION.Domain.Entities.TenantIdentityConfigurationEntity", "TenantIdentityConfiguration")
                        ...
                        .HasForeignKey("AUTHIO.APPLICATION.Domain.Entities.LockoutIdentityConfigurationEntity", "TenantIdentityConfigurationId")
